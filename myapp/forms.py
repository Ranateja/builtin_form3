...
class SampleForm(forms.Form):
    first_name=forms.CharField(max_length=20,required=True,label="First Name",widget=forms.TextInput(attrs={'placeholder':"first name"}),help_text="Note:Space and Spl charecters are not allowed")
